...
__name(createBindingsRoutes, "createBindingsRoutes");
function createD1Routes() {
  ...
  __name(getPrimaryKeys, "getPrimaryKeys");
  ...
  __name(buildPrimaryKeyWhere, "buildPrimaryKeyWhere");
  app2.get("/", async (c) => {
    const manifest = getManifest(c.env);
    return c.json({
...
__name(createD1Routes, "createD1Routes");
function createKVRoutes() {
  ...
  app2.get("/:binding/keys", async (c) => {
    ...
    try {
      const prefix2 = c.req.query("prefix") || void 0;
...
__name(createKVRoutes, "createKVRoutes");
...
__name(createR2Routes, "createR2Routes");
...
__name(createQueuesRoutes, "createQueuesRoutes");
...
__name(createDORoutes, "createDORoutes");
...
__name(createLogsRoutes, "createLogsRoutes");
...
__name(createRequestsRoutes, "createRequestsRoutes");
...
__name(createAnalyticsRoutes, "createAnalyticsRoutes");
var app = new Hono2();
app.use(
  "*",
  cors({
...
var prefix = "[localflare-api]";

// ../../node_modules/.pnpm/wrangler@4.73.0_@cloudflare+workers-types@4.20260313.1/node_modules/wrangler/templates/middleware/middleware-patch-console-prefix.ts
...
// .wrangler/tmp/bundle-EPLsEz/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-EPLsEz/middleware-loader.entry.ts
